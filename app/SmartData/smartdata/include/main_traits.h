...
template <>
struct Traits<Project> : public Traits<Build> {
...
template <>
struct Traits<Vehicle_Models_Parameters> : public Traits<Build> {
    ...
    // this parameters have been extracted from CARLA blueprint library, please, change this to the respective vehicle before
...
template <>
struct Traits<SmartData> : public Traits<Build> {
...
template <>
struct Traits<Network> : public Traits<Build> {
...
template <>
struct Traits<Only_Data_UDP_Wrapper> : public Traits<Build> {
    static const unsigned short UNDERLYING_PROTOCOL = 0x8401;  // TSTP
};

template <>
struct Traits<TSTP> : public Traits<Network> {
