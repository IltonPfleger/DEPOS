...
template<UInt32 U>
class Fake_Data: public Transducer<U>
{
...
public:
    Fake_Data(const SmartData::Device_Id & dev): _value(0) {
        _generator = new Periodic_Thread(PERIOD, PERIOD, &generate, reinterpret_cast<void*>(this));
    }
...
template<UInt32 U>
class Fake_Data_Digital: public Transducer<U>
{
...
public:
    Fake_Data_Digital(const SmartData::Device_Id & dev): _value(0) {
        _generator = new Periodic_Thread(PERIOD, 0, &generate, reinterpret_cast<void*>(this));
    }
...
using Map = Responsive_SmartData<Fake_Data_Digital<SmartData::Unit::MOTION_VECTOR_GLOBAL|Traits<Project>::MAX_MAP_POINTS>>;
