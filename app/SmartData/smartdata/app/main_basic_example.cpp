...
void create_daemon(UInt32 dev, SmartData::Time period, SmartData::Time expiry, UInt32 iterations)
{
    ...
    case 3: {
        ...
        Temperature_Adjust_Proxy tap(Temperature_Adjust_Proxy::Region(0, 0, 0, 100, Temperature_Adjust_Proxy::now(), Temperature_Adjust_Proxy::now() + iterations * period), expiry, 0, SmartData::SINGLE, 2);
