    ...
    class Context {
      public:
        ...
        Context(int (*entry)(void *), void *a0, void (*exit)()) {
            ...
            this->status = static_cast<Register>(KernelMode::handoff()) |
                           static_cast<Register>(KernelMode::PIRQE);
        ...
        template <typename T = KernelMode> void load() {
            asm volatile(
                ...
                : [sp] "r"(this), [ra] "i"(offsetof(Context, ra)),
                  [gp] "i"(offsetof(Context, gp)),
                  [s0] "i"(offsetof(Context, s0)),
                  [s1] "i"(offsetof(Context, s1)),
                  [a0] "i"(offsetof(Context, a0)),
                  [s2] "i"(offsetof(Context, s2)),
                  [s3] "i"(offsetof(Context, s3)),
                  [s4] "i"(offsetof(Context, s4)),
                  [s5] "i"(offsetof(Context, s5)),
                  [s6] "i"(offsetof(Context, s6)),
                  [s7] "i"(offsetof(Context, s7)),
                  [s8] "i"(offsetof(Context, s8)),
                  [s9] "i"(offsetof(Context, s9)),
                  [s10] "i"(offsetof(Context, s10)),
                  [s11] "i"(offsetof(Context, s11)),
                  [size] "i"(sizeof(Context)), [estatus] "i"(T::STATUS),
                  [epc] "i"(T::EPC), [pc] "i"(offsetof(Context, pc)),
        ...
        __attribute__((naked)) static void swtch(Context **previous,
            ...
            asm volatile(
                ...
                : [ra] "i"(offsetof(Context, ra)),
                  ...
                  [s10] "i"(offsetof(Context, s10)),
                  [s11] "i"(offsetof(Context, s11)),
                  [size] "i"(-sizeof(Context)), [statusr] "i"(T::STATUS),
        ...
        __attribute__((always_inline)) static inline Context *push() {
            asm volatile(
                ...
                : [ra] "i"(offsetof(Context, ra)),
                  [gp] "i"(offsetof(Context, gp)),
                  [t0] "i"(offsetof(Context, t0)),
                  [t1] "i"(offsetof(Context, t1)),
                  [t2] "i"(offsetof(Context, t2)),
                  [t3] "i"(offsetof(Context, t3)),
                  [t4] "i"(offsetof(Context, t4)),
                  [t5] "i"(offsetof(Context, t5)),
                  [t6] "i"(offsetof(Context, t6)),
                  [a0] "i"(offsetof(Context, a0)),
                  [a1] "i"(offsetof(Context, a1)),
                  [a2] "i"(offsetof(Context, a2)),
                  [a3] "i"(offsetof(Context, a3)),
                  [a4] "i"(offsetof(Context, a4)),
                  [a5] "i"(offsetof(Context, a5)),
                  [a6] "i"(offsetof(Context, a6)),
