class CLINT {
    ...
    static volatile inline uintmax_t *MTIMECMP =
        reinterpret_cast<volatile uintmax_t *>(Addr + 0x4000);
    static volatile inline uintmax_t *MTIME =
        reinterpret_cast<volatile uintmax_t *>(Addr + 0xBFF8);
